    ...
    try {
      ...
      if (response.ok) {
        ...
        const inProgress = (data.orders || []).filter((o: any) => 
          ['approved', 'assigned', 'in_progress', 'editing'].includes(o.status)
        ).map((o: any) => ({
          id: o.id,
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="lg:ml-64 pt-[72px]">
        <div className="p-4 md:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <Card className="bg-gradient-to-br from-blue-500 to-cyan-600 text-white border-0 shadow-lg">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-normal opacity-90">Active Orders</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Active Orders List</CardTitle>
            </CardHeader>
            <CardContent>
              {loadingJobs ? (
                ...
                <div className="text-center py-12 bg-muted/30 rounded-lg">
                  ...
                  <p className="text-base font-medium mb-2">No orders in progress</p>
                  <p className="text-sm text-muted-foreground">Orders being worked on will appear here</p>
                </div>
              ) : (
                      ...
                      {jobs.map((job) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <Badge variant="secondary" className="capitalize bg-blue-100 text-blue-900 dark:bg-blue-900 dark:text-blue-100">
