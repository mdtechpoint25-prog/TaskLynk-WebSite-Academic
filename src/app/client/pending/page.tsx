  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const pending = (data.orders || []).filter((o: any) => o.status === 'pending').map((o: any) => ({
          id: o.id,
      ...
      <div className="lg:ml-64 pt-[72px]">
        <div className="p-4 md:p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground">Orders awaiting admin approval</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <Card className="bg-gradient-to-br from-amber-500 to-orange-600 text-white border-0 shadow-lg">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-normal opacity-90">Pending Approval</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <CardContent>
              {loadingJobs ? (
                ...
                <div className="text-center py-12 bg-muted/30 rounded-lg">
                  ...
                  <p className="text-base font-medium mb-2">No pending orders</p>
                  <p className="text-sm text-muted-foreground">All orders have been approved</p>
                </div>
              ) : (
                      ...
                      {jobs.map((job) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <Badge variant="secondary" className="capitalize bg-amber-100 text-amber-900 dark:bg-amber-900 dark:text-amber-100">
                              Pending
                            </Badge>
                          </td>
