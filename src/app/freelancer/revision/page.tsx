...
export default function RevisionPage() {
  ...
  const filteredJobs = useMemo(() => {
    return jobs.filter(j => j.status === 'revision');
  }, [jobs]);
        ...
        <div className="p-3 md:p-4 lg:p-5 w-full">
          <div className="mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              View orders that have been sent back for revision. Address client feedback and re-upload updated work.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Revision Orders</CardTitle>
          ...
          {loadingJobs ? (
            ...
            <Card>
              <CardContent className="text-center py-12">
                ...
                <p className="text-muted-foreground">No revision orders</p>
              </CardContent>
            </Card>
          ) : (
